...
# 输入 honeygain 的个人 信息
input_token(){
  [ -z $EMAIL ] && reading " Enter your Email, if you do not find it, open https://r.honeygain.me/24610E80CD: " thoufeeqisin@gmail.com 
  [ -z $PASSWORD ] && reading " Enter your Password: " Thoufeeq$369
